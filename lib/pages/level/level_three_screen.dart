...
class _LevelThreeScreenState extends State<LevelThreeScreen> with TickerProviderStateMixin {
  ...
  final Color _backgroundColor1 = const Color(0xFF89CFF0); // Light blue gradient start
  final Color _backgroundColor2 = const Color(0xFF6BA6DE); // Medium blue gradient middle
  final Color _backgroundColor3 = const Color(0xFF4682B4); // Deep blue gradient end
                    ...
                    Stack(
                      children: [
                        ...
                        AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [Color(0xFF64B5F6), Color(0xFF1565C0)], // Light blue to deep blue
